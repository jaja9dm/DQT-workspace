...
- **leader (주도주)**: 오늘 시장 자금이 가장 많이 몰리는 종목. ⭐주도주 태그 우선. 하루 종일 방향이 명확해야 함.
  ...
  **[필수 조건]** 거래대금 500억 미만 종목은 leader 슬롯 배정 불가 — 소형주는 급등 후 급락 위험이 높아 하루 종일 방향성을 유지하기 어렵습니다. 거래대금이 적은 종목이 기술점수가 높더라도 leader에는 배정하지 않습니다. 같은 조건이면 거래대금이 가장 큰 종목을 leader로 선택하세요.
...
def _build_user_message(
    ...
    return (
        ...
        f"⭐주도주 태그 = 전체 시장 거래대금 상위 종목 → leader 슬롯 우선 배정.\n"
